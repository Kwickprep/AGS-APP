...
class _UserScreenState extends State<UserScreen> {
  ...
  Widget _buildUserCard(UserScreenModel user, int serialNumber) {
    return RecordCard(
      ...
      createdBy: user.createdInfo.isNotEmpty && user.createdInfo != '-' ? user.createdInfo : user.createdBy,
      createdAt: user.createdInfo.isNotEmpty && user.createdInfo != '-' ? null : formatDate(user.createdAt),
      updatedBy: user.updatedInfo != null && user.updatedInfo!.isNotEmpty && user.updatedInfo != '-' ? user.updatedInfo : null,
